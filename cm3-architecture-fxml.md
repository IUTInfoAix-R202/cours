...
<div style="background: #e8a838; color: white; padding: 0.5rem 0.9rem; border-radius: 6px 6px 0 0; font-weight: bold; font-size: 1.3rem; margin-top: 0.4rem;">🇫🇷 messages_fr.properties</div>
...
<div style="background: rgba(74,144,217,0.15); padding: 0.5rem 1rem; border-radius: 6px; margin-top: 0.4rem; font-size: 1.1rem; text-align: center; color: #2c3e50;">
🔍 Si la locale système est <code>fr_FR</code>, Java cherche <code>messages_fr.properties</code> <span style="opacity: 0.75;">(convention : <code>baseName_langue.properties</code>)</span>.
</div>

<div style="background: #2c3e50; color: white; padding: 0.7rem 1.2rem; border-radius: 8px; margin-top: 0.4rem; font-size: 1.4rem; text-align: center;">
Aucune ligne Java à modifier pour traduire. Le FXML reste neutre, le bundle change selon la <code>Locale</code>.
</div>
...
# Partie 4 - 🎨 SceneBuilder

**L'éditeur graphique WYSIWYG**
...
<svg viewBox="0 10 1100 280" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" style="width: 100%; display: block; margin: 0.3rem auto;">
  ...
  <text x="360" y="210" text-anchor="middle" font-family="sans-serif" font-size="13" fill="#2c3e50">sauvegarde</text>
...
# Partie 5 - 🧩 Composants et composition

**fx:root, fx:include, exemple complet**
...
<div style="background: #2c3e50; color: white; padding: 0.7rem 1.2rem; border-radius: 8px; margin-top: 0.5rem; font-size: 1.5rem; text-align: center;">
💡 Ce mécanisme est la <b>clé du pattern <code>fx:root</code></b> qu'on découvre juste après : un composant qui charge son propre FXML et s'auto-déclare racine + contrôleur.
</div>
...
<BorderPane xmlns:fx="http://javafx.com/fxml" fx:controller="fr.univ_amu.iut.AppController">
  <top>
...
# Partie 6 - 🧠 Cohérence et standards
...
<div style="background: white; border-radius: 6px; padding: 0.6rem; margin-top: 0.5rem; display: flex; gap: 0.5rem; align-items: center; justify-content: center;">
  ...
  <button style="font-family: 'Roboto', sans-serif; font-size: 0.9rem; font-weight: 500; letter-spacing: 0.05em; text-transform: uppercase; padding: 0.45rem 1.1rem; background: #e8def8; color: #6750a4; border: none; border-radius: 18px; cursor: pointer;">Annuler</button>
</div>
</div>

<div style="background: #1d1d1f; color: white; padding: 0.9rem 1.1rem; border-radius: 10px; display: flex; flex-direction: column;">
<div style="font-size: 1.5rem; font-weight: bold; margin-bottom: 0.35rem;">⚪ Apple HIG</div>
<div style="font-size: 1.2rem; line-height: 1.4; flex: 1;"><em>Human Interface Guidelines</em>, depuis 1987. Référence macOS, iOS, watchOS, visionOS.<br/><a href="https://developer.apple.com/design/human-interface-guidelines/" style="color: #d0e0ff;">developer.apple.com/design</a></div>
<div style="background: #f2f2f7; border-radius: 6px; padding: 0.6rem; margin-top: 0.5rem; display: flex; gap: 0.5rem; align-items: center; justify-content: center;">
  <button style="font-family: -apple-system, 'SF Pro', sans-serif; font-size: 0.9rem; font-weight: 600; padding: 0.45rem 1.3rem; background: #007aff; color: white; border: none; border-radius: 10px; cursor: pointer;">Continuer</button>
  <button style="font-family: -apple-system, 'SF Pro', sans-serif; font-size: 0.9rem; font-weight: 600; padding: 0.45rem 1.3rem; background: #e5e5ea; color: #007aff; border: none; border-radius: 10px; cursor: pointer;">Annuler</button>
</div>
</div>

<div style="background: #2557a7; color: white; padding: 0.9rem 1.1rem; border-radius: 10px; display: flex; flex-direction: column;">
<div style="font-size: 1.5rem; font-weight: bold; margin-bottom: 0.35rem;">🟦 Fluent (Microsoft)</div>
<div style="font-size: 1.2rem; line-height: 1.4; flex: 1;">Successeur de Metro. Cohérence Windows, Office, Teams, Xbox.<br/><a href="https://fluent2.microsoft.design/" style="color: #d0e0ff;">fluent2.microsoft.design</a></div>
<div style="background: #faf9f8; border-radius: 6px; padding: 0.6rem; margin-top: 0.5rem; display: flex; gap: 0.5rem; align-items: center; justify-content: center;">
  <button style="font-family: 'Segoe UI', sans-serif; font-size: 0.9rem; padding: 0.4rem 1rem; background: #0078d4; color: white; border: 1px solid #005a9e; border-radius: 2px; cursor: pointer;">Continuer</button>
  <button style="font-family: 'Segoe UI', sans-serif; font-size: 0.9rem; padding: 0.4rem 1rem; background: white; color: #323130; border: 1px solid #8a8886; border-radius: 2px; cursor: pointer;">Annuler</button>
</div>
</div>

<div style="background: #000091; color: white; padding: 0.9rem 1.1rem; border-radius: 10px; display: flex; flex-direction: column;">
<div style="font-size: 1.5rem; font-weight: bold; margin-bottom: 0.35rem;">🇫🇷 DSFR (État français)</div>
<div style="font-size: 1.2rem; line-height: 1.4; flex: 1;"><em>Design System de l'État français</em>. Tous les sites <code>.gouv.fr</code>.<br/><a href="https://www.systeme-de-design.gouv.fr/" style="color: #d0e0ff;">systeme-de-design.gouv.fr</a></div>
<div style="background: white; border-radius: 6px; padding: 0.6rem; margin-top: 0.5rem; display: flex; gap: 0.5rem; align-items: center; justify-content: center;">
  <button style="font-family: 'Marianne', sans-serif; font-size: 0.9rem; font-weight: 500; padding: 0.45rem 1.1rem; background: #000091; color: white; border: none; border-radius: 0; cursor: pointer;">Continuer</button>
  <button style="font-family: 'Marianne', sans-serif; font-size: 0.9rem; font-weight: 500; padding: 0.45rem 1.1rem; background: white; color: #000091; border: 1px solid #000091; border-radius: 0; cursor: pointer;">Annuler</button>
</div>
</div>
